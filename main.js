...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '𝙇𝙪𝙡𝙪 𝙡𝙖 𝙢𝙚𝙟𝙤𝙧 𝙗𝙤𝙩 𝙩𝙚 𝙙𝙖 𝙡𝙖 𝙗𝙞𝙚𝙣𝙫𝙚𝙣𝙞𝙙𝙖 @user 🌼';
  conn.bye = '𝙇𝙪𝙡𝙪 𝙨𝙚 𝙙𝙚𝙨𝙥𝙞𝙙𝙚 𝙙𝙚  @user  𝙥𝙤𝙧𝙦𝙪𝙚 𝙨𝙚 𝙨𝙖𝙡𝙞ó 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤 🌼';
  conn.spromote = '𝙀𝙔 𝙏𝙐 @𝙪𝙨𝙚𝙧  𝘼𝙃𝙊𝙍𝘼 𝙀𝙍𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙁𝙀𝙇𝙄𝘾𝙄𝘿𝘼𝘿𝙀𝙎 🌼';
  conn.sdemote = '𝙀𝙮 @user 𝙅𝙖𝙟𝙖𝙟𝙖 𝙁𝙪𝙞𝙨𝙩𝙚 𝘿𝙚𝙜𝙧𝙖𝙙𝙖𝙙𝙤 𝘼 𝙋𝙖𝙧𝙩𝙞𝙘𝙞𝙥𝙖𝙣𝙩𝙚 𝙉𝙤𝙧𝙢𝙖𝙡 𝙀𝙣 𝙀𝙡 𝙈𝙚𝙟𝙤𝙧 𝙂𝙧𝙪𝙥𝙤 🌼';
  conn.sDesc = '𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄Ó𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙁𝙐𝙀 𝘾𝘼𝙈𝘽𝙄𝘼𝘿𝘼 𝙋𝙊𝙍 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 🌼';
  conn.sSubject = '𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝘼 𝙎𝙄𝘿𝙊 𝘾𝘼𝙈𝘽𝙄𝘼𝘿𝙊  🌼';
  conn.sIcon = '𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝘼𝙃 𝘾𝘼𝙈𝘽𝙄𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀 𝙋𝙀𝙍𝙁𝙄𝙇 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊🌼';
  conn.sRevoke = '𝙀𝙇 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙔𝘼 𝙉𝙊 𝙀𝙎 𝙀𝙇 𝙈𝙄𝙎𝙈𝙊 🌼';
...
setInterval(async () => {
  ...
  const bio = `𝒉𝒐𝒍𝒂 ¿𝑸𝒖𝒆 𝒕𝒂𝒍? 𝒔𝒐𝒚 𝑳𝒖𝒍𝒖 𝒚 𝒆𝒔𝒕á𝒔 𝒗𝒊𝒆𝒏𝒅𝒐 𝒎𝒊 𝒑𝒆𝒓𝒇𝒊𝒍🌼`;
